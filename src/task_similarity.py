...
def plot_distance_matrix(embeddings, labels=None, num_clients=0, distance="cosine", dataset_name="", alpha="", test_id=0):
    ...
    plt.savefig(f'results/heatmap_metodo_{num_clients}_{dataset_name}_{alpha}_{test_id}.png')
    # plt.show()
